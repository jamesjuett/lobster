        ...
        fullCompilationFinished: function (msg) {
            ...
            for (var i = 0; i < notes.length; ++i) {
                ...
                if (sourceRef) {
                    ...
                    editor.addAnnotation(GutterAnnotation.instance(sourceRef, note.getType(), note.getMessage()));
                }
            }
...
Lobster.Outlets.CPP.SourceSimulation = Outlets.CPP.RunningCode.extend({
    ...
    valueTransferOverlay: function (fromOutlet, toOutlet, html, duration, afterCallback) {
        ...
        while (fromFuncOutlet && !isA(fromFuncOutlet, Outlets.CPP.Function)) {
            fromFuncOutlet = fromFuncOutlet.parent;
        }
        while (toFuncOutlet && !isA(toFuncOutlet, Outlets.CPP.Function)) {
            toFuncOutlet = toFuncOutlet.parent;
        }
