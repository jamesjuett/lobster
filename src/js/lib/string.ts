...
// import { RuntimeOpaqueStatement, registerOpaqueStatement } from "../core/statements";
// import { MemberSubobject, CPPObject } from "../core/objects";
// import { Int, Char, PointerType, BoundedArrayType, CompleteObjectType, ReferenceType, CompleteClassType, ArrayPointerType, Size_t } from "../core/types";
...
// function getLocal<T extends CompleteObjectType>(rt: RuntimeOpaqueStatement, name: string) {
...
// registerOpaqueStatement("string::string_default", (rt: RuntimeOpaqueStatement) => {
...
// registerOpaqueStatement("string::string_copy", (rt: RuntimeOpaqueStatement) => {
...
// registerOpaqueStatement("string::string_substring_1", (rt: RuntimeOpaqueStatement) => {

// });

// registerOpaqueStatement("string::string_substring_2", (rt: RuntimeOpaqueStatement) => {

// });

// registerOpaqueStatement("string::string_cstring", (rt: RuntimeOpaqueStatement) => {

// });

// registerOpaqueStatement("string::string_cstring_n", (rt: RuntimeOpaqueStatement) => {

// });

// registerOpaqueStatement("string::string_fill", (rt: RuntimeOpaqueStatement) => {

// });

// registerOpaqueStatement("string::~string", (rt: RuntimeOpaqueStatement) => {

// });

// registerOpaqueStatement("string::operator=_copy", (rt: RuntimeOpaqueStatement) => {

// });

// registerOpaqueStatement("string::operator=_cstring", (rt: RuntimeOpaqueStatement) => {

// });

// registerOpaqueStatement("string::operator=_char", (rt: RuntimeOpaqueStatement) => {

// });

// registerOpaqueStatement("string::size", (rt: RuntimeOpaqueStatement) => {

// });

// registerOpaqueStatement("string::length", (rt: RuntimeOpaqueStatement) => {

// });

// registerOpaqueStatement("string::resize_", (rt: RuntimeOpaqueStatement) => {
...
// registerOpaqueStatement("string::capacity", (rt: RuntimeOpaqueStatement) => {

// });

// registerOpaqueStatement("string::clear", (rt: RuntimeOpaqueStatement) => {

// });

// registerOpaqueStatement("string::empty", (rt: RuntimeOpaqueStatement) => {

// });

// registerOpaqueStatement("string::operator[]", (rt: RuntimeOpaqueStatement) => {

// });

// registerOpaqueStatement("string::operator[]_const", (rt: RuntimeOpaqueStatement) => {

// });

// registerOpaqueStatement("string::at", (rt: RuntimeOpaqueStatement) => {
...
// registerOpaqueStatement("string::at_const", (rt: RuntimeOpaqueStatement) => {

// });

// registerOpaqueStatement("string::front", (rt: RuntimeOpaqueStatement) => {

// });

// registerOpaqueStatement("string::front_const", (rt: RuntimeOpaqueStatement) => {
