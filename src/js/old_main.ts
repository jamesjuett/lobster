...
var handleWhoAmI = function (data) {
    ...
    var codeList = CodeList.instance(elem, "api/", simOutlet.projectEditor, false);
    simOutlet.listenTo(codeList);

    elem = $(".codeListMe");
    codeList = CodeList.instance(elem, "api/me/", simOutlet.projectEditor, true);
    simOutlet.listenTo(codeList);

    var projectList = ProjectList.instance($(".projectList"));
