...
export class SimpleExerciseLobsterOutlet {
    ...
    public constructor(element: JQuery, project: Project) {
        ...
        this.instantMemoryDiagramOutlet = new InstantMemoryDiagramOutlet(
            IMDOElem,
            project,
            false
        );
        ...
        element
            .find(".lobster-instant-memory-diagram-buttons button")
            .on("click", () => {
                ...
                this.isInstantMemoryDiagramActive =
                    !this.isInstantMemoryDiagramActive;
                this.instantMemoryDiagramOutlet.setActive(
                    this.isInstantMemoryDiagramActive
                );
