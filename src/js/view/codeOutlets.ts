...
export function getValueString(value: Value) {
    ...
    //  ../core/declarations/declarations.type.arrayObject.getValue().slice(offset);
    //     if (chars.length === 0) {
