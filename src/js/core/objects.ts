...
type ObjectValueRepresentation<T extends CompleteObjectType> = T extends AtomicType
  ? Value<T>
...
type ObjectRawValueRepresentation<T extends CompleteObjectType> = T extends AtomicType
  ? RawValueType
  : T extends BoundedArrayType<infer Elem_type>
...
export class InvalidObject<T extends CompleteObjectType = CompleteObjectType> extends CPPObject<T> {
  ...
  public describe(): ObjectDescription {
    return {
      ...
      message: `an invalid object at ${toHexadecimalString(this.address)}`,
    };
  }
}
...
export class BaseSubobject extends Subobject<CompleteClassType> {
  ...
  public describe(): ObjectDescription {
    ...
    return {
      ...
      message: 'the ' + this.type.className + ' base of ' + contDesc.message,
    };
  }
}

export class MemberSubobject<T extends CompleteObjectType = CompleteObjectType> extends Subobject<
  T
> {
  public readonly containingObject!: CPPObject<CompleteClassType>; // Handled by parent (TODO: is this a good idea?)
  public readonly name: string;
...
export class TemporaryObject<T extends CompleteObjectType = CompleteObjectType> extends CPPObject<
  T
> {
