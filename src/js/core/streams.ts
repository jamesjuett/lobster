...
type StandardInputStreamMessages = "bufferUpdated" | "iostateUpdated";

export class StandardInputStream {
    public readonly observable = new Observable<StandardInputStreamMessages>(
        this
    );
    ...
    public extractAndParseFromBuffer(
        type: ArithmeticType
    ): SuccessParsingResult<ArithmeticType> | undefined {
