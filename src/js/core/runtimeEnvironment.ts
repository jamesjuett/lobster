...
import { Bool, Char, ObjectPointerType, ArrayPointerType, similarType, subType, PointerType, ObjectType, sameType, AtomicType, IntegralType, Int, ArrayElemType, BoundedArrayType, ReferenceType, ReferenceType } from "./types";
...
export class MemoryFrame {
    ...
    public localReferenceLookup<T extends ObjectType>(entity: LocalReferenceEntity<ReferenceType<T>>) {
