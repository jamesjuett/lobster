...
export class ForStatement extends Statement<ForStatementASTNode> {
    ...
    public static createFromAST(ast: ForStatementASTNode, funcContext: BlockContext): ForStatement {
      ...
      let body = ast.body.construct_type === "block" ?
        createStatementFromAST(ast.body, funcContext) :
        createStatementFromAST(ast.body, createBlockContext(funcContext));
      ...
      return new ForStatement(funcContext, ast,
