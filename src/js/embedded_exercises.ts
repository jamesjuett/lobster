...
$(() => {
  ...
  $('.lobster-ex').each(function() {
    ...
    let completionMessage =
      $(this)
        .find('.lobster-ex-completion-message')
        .html()
        ?.trim() ??
      $(this)
        .find('.lobster-ex-complete-message')
        .html()
        ?.trim();
    ...
    let initCode = decode(
      $(this)
        .find('.lobster-ex-starter-code')
        .html()
        ?.trim() ??
        $(this)
          .find('.lobster-ex-init-code')
          .html()
          ?.trim() ??
        ''
    );
