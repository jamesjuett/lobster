...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c176 = function(specs: any, decl: any): any { return track({specs:specs, declarator:decl}, location(), text()); };
  const peg$c177 = function(): any { return {const: true, volatile: true}; };
  const peg$c178 = function(): any { return {const: true}; };
  const peg$c179 = function(): any { return {volatile: true}; };
  const peg$c180 = function(first: any, arg: any): any {return arg;};
  const peg$c181 = function(first: any, rest: any): any { rest.unshift(first); return rest; };
  const peg$c182 = function(): any {return [];};
  const peg$c183 = function(specs: any, decl: any, init: any): any {return track({construct_type:"parameter_declaration", declarator:decl, specs:specs, initializer:init}, location(), text()); };
  const peg$c184 = function(specs: any, decl: any): any {return track({construct_type:"parameter_declaration", specs:specs, declarator:decl}, location(), text()); };
  const peg$c185 = function(first: any, op: any, e: any): any {return [op,e];};
  const peg$c186 = function(first: any, rest: any): any { return track(composeBinaryOp(first, rest, "left", "comma_expression"), location(), text()); };
  const peg$c187 = function(lhs: any, op: any, rhs: any): any { return track({construct_type: "assignment_expression", lhs:lhs, operator:op, rhs:rhs}, location(), text()); };
  const peg$c188 = function(lhs: any, op: any, rhs: any): any { return track({construct_type: "compound_assignment", lhs:lhs, operator:op, rhs:rhs}, location(), text()); };
  const peg$c189 = "*=";
  ...
  const peg$c205 = "and_eq";
  const peg$c206 = peg$literalExpectation("and_eq", false);
  const peg$c207 = function(): any {return "&=";};
  const peg$c208 = "^=";
  const peg$c209 = peg$literalExpectation("^=", false);
  const peg$c210 = "xor_eq";
  const peg$c211 = peg$literalExpectation("xor_eq", false);
  const peg$c212 = function(): any {return "^=";};
  const peg$c213 = "|=";
  const peg$c214 = peg$literalExpectation("|=", false);
  const peg$c215 = "or_eq";
  const peg$c216 = peg$literalExpectation("or_eq", false);
  const peg$c217 = function(): any {return "|=";};
  const peg$c218 = function(sub: any): any { sub.constant = true; return sub; };
  const peg$c219 = "?";
  const peg$c220 = peg$literalExpectation("?", false);
  const peg$c221 = function(condition: any, then: any, otherwise: any): any { return track({construct_type: "ternary_expression", condition:condition, then:then, otherwise:otherwise}, location(), text()); };
  const peg$c222 = "||";
  const peg$c223 = peg$literalExpectation("||", false);
  const peg$c224 = "or";
  const peg$c225 = peg$literalExpectation("or", false);
  const peg$c226 = function(first: any, op: any, e: any): any {return ["||",e];};
  const peg$c227 = function(first: any, rest: any): any { return track(composeBinaryOp(first, rest, "left", "logical_binary_operator_expression"), location(), text()); };
  const peg$c228 = "&&";
  const peg$c229 = peg$literalExpectation("&&", false);
  const peg$c230 = "and";
  const peg$c231 = peg$literalExpectation("and", false);
  const peg$c232 = function(first: any, op: any, e: any): any {return ["&&",e];};
  const peg$c233 = "|";
  const peg$c234 = peg$literalExpectation("|", false);
  const peg$c235 = "bitor";
  const peg$c236 = peg$literalExpectation("bitor", false);
  const peg$c237 = function(first: any, op: any, e: any): any {return ["|",e];};
  const peg$c238 = function(first: any, rest: any): any { return track(composeBinaryOp(first, rest, "left", "arithmetic_binary_operator_expression"), location(), text()); };
  const peg$c239 = "^";
  const peg$c240 = peg$literalExpectation("^", false);
  const peg$c241 = "xor";
  const peg$c242 = peg$literalExpectation("xor", false);
  const peg$c243 = function(first: any, op: any, e: any): any {return ["^",e];};
  const peg$c244 = "bitand";
  const peg$c245 = peg$literalExpectation("bitand", false);
  const peg$c246 = function(first: any, op: any, e: any): any {return ["&",e];};
  const peg$c247 = "==";
  const peg$c248 = peg$literalExpectation("==", false);
  const peg$c249 = "!=";
  const peg$c250 = peg$literalExpectation("!=", false);
  const peg$c251 = "not_eq";
  const peg$c252 = peg$literalExpectation("not_eq", false);
  const peg$c253 = function(first: any): any {return "!=";};
  const peg$c254 = function(first: any, rest: any): any { return track(composeBinaryOp(first, rest, "left", "relational_binary_operator_expression"), location(), text()); };
  const peg$c255 = "<=";
  ...
  const peg$c275 = function(first: any, rest: any): any { return track(composeBinaryOp(first, rest, "left", "pointer_to_member_expression"), location(), text()); };
  const peg$c276 = ".*";
  const peg$c277 = peg$literalExpectation(".*", false);
  const peg$c278 = "->*";
  const peg$c279 = peg$literalExpectation("->*", false);
  const peg$c280 = function(t: any, sub: any): any {
  ...
  const peg$c288 = "sizeof";
  const peg$c289 = peg$literalExpectation("sizeof", false);
  ...
  const peg$c292 = function(): any {return {construct_type: "dereference_expression", operator: "*"};};
  const peg$c293 = function(): any {return {construct_type: "address_of_expression", operator: "&"};};
  const peg$c294 = function(): any {return {construct_type: "unary_plus_expression", operator: "+"};};
  const peg$c295 = function(): any {return {construct_type: "unary_minus_expression", operator: "-"};};
  const peg$c296 = "!";
  const peg$c297 = peg$literalExpectation("!", false);
  const peg$c298 = function(): any {return {construct_type: "logical_not_expression", operator: "!"};};
  const peg$c299 = "not";
  const peg$c300 = peg$literalExpectation("not", false);
  const peg$c301 = "~";
  ...
  const peg$c371 = function(lit: any): any {return track({construct_type: "numeric_literal_expression", type:"float", value:lit}, location(), text());};
  const peg$c372 = function(lit: any): any {return track({construct_type: "numeric_literal_expression", type:"int", value:lit}, location(), text());};
  const peg$c373 = function(lit: any): any {return track({construct_type: "numeric_literal_expression", type:"char", value:lit}, location(), text());};
  const peg$c374 = function(lit: any): any {return track({construct_type: "string_literal_expression", type:"string", value:lit}, location(), text());};
  const peg$c375 = function(lit: any): any {return track({construct_type: "numeric_literal_expression", type:"bool", value:lit}, location(), text());};
  const peg$c376 = /^[0-9]/;
  ...
  const peg$c436 = function(head: any): any {
        classNameStack.push(head.name.identifier);
        getUserTypeNames()[head.name.identifier]=true;
        return true;
      };
  const peg$c437 = function(head: any, mems: any): any { 
        classNameStack.pop();
        return track({construct_type: "class_definition", head: head, memberSpecs: mems}, location(), text());
      };
  const peg$c438 = function(head: any): any { classNameStack.pop(); return false; };
  const peg$c439 = function(key: any, name: any, b: any): any {return b;};
  const peg$c440 = function(key: any, name: any, bases: any): any { return track({construct_type: "class_head", classKey:key, name:name, bases:bases ?? []}, location(), text()); };
  const peg$c441 = "class";
  const peg$c442 = peg$literalExpectation("class", false);
  const peg$c443 = "struct";
  const peg$c444 = peg$literalExpectation("struct", false);
  const peg$c445 = "union";
  const peg$c446 = peg$literalExpectation("union", false);
  const peg$c447 = function(m: any): any {return m};
  const peg$c448 = function(members: any): any { return track({construct_type: "member_specification", members: members}, location(), text()); };
  ...
  const peg$c451 = "private";
  const peg$c452 = peg$literalExpectation("private", false);
  const peg$c453 = "protected";
  const peg$c454 = peg$literalExpectation("protected", false);
  const peg$c455 = "public";
  const peg$c456 = peg$literalExpectation("public", false);
  const peg$c457 = function(specs: any, declarators: any): any {
        return track({construct_type: "simple_member_declaration", specs:specs, declarators:declarators}, location(), text());
      };
  const peg$c458 = function(declarators: any): any {
  ...
  const peg$c464 = function(d: any, i: any): any {d.initializer = i; return d;};
