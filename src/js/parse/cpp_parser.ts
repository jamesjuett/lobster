...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c354 = function(id: any): any { return track({construct_type: "identifier_expression", identifier: id}, location(), text()); };
  const peg$c355 = function(n: any): any { return KEYWORDS.has(n.identifier); };
  const peg$c356 = function(n: any): any { return n; };
  const peg$c357 = function(n: any): any { return {construct_type: "unqualified_identifier", identifier: "~"+n.identifier}; };
  const peg$c358 = function(n: any, u: any): any {
      n.push(u);
      return {construct_type: "qualified_identifier", components: n};
    };
  const peg$c359 = "::";
  const peg$c360 = peg$literalExpectation("::", false);
  const peg$c361 = function(id: any): any {return id;};
  const peg$c362 = function(): any { return [];};
  const peg$c363 = function(id: any): any {return track({identifier: id}, location(), text());};
  const peg$c364 = "operator";
  const peg$c365 = peg$literalExpectation("operator", false);
  const peg$c366 = function(op: any): any {return track({construct_type: "unqualified_identifier", identifier: "operator"+op, operator: op}, location(), text());};
  const peg$c367 = "new[]";
  ...
  const peg$c377 = function(lit: any): any {return track({construct_type: "numeric_literal_expression", type:"float", value:lit}, location(), text());};
  const peg$c378 = function(lit: any): any {return track({construct_type: "numeric_literal_expression", type:"int", value:lit}, location(), text());};
  const peg$c379 = function(lit: any): any {return track({construct_type: "numeric_literal_expression", type:"char", value:lit}, location(), text());};
  const peg$c380 = function(lit: any): any {return track({construct_type: "string_literal_expression", type:"string", value:lit}, location(), text());};
  const peg$c381 = function(lit: any): any {return track({construct_type: "numeric_literal_expression", type:"bool", value:lit}, location(), text());};
  const peg$c382 = /^[0-9]/;
  const peg$c383 = peg$classExpectation([["0", "9"]], false, false);
  const peg$c384 = function(neg: any, digits: any): any { return parseInt((neg ? neg : "") + digits.join("")); };
  const peg$c385 = /^[0-9.]/;
  const peg$c386 = peg$classExpectation([["0", "9"], "."], false, false);
  const peg$c387 = function(neg: any, digits: any): any {return digits.indexOf(".") == digits.lastIndexOf(".") && digits.indexOf(".") != -1;};
  const peg$c388 = function(neg: any, digits: any): any { return parseFloat((neg ? neg : "") + digits.join("")); };
  const peg$c389 = "'";
  const peg$c390 = peg$literalExpectation("'", false);
  const peg$c391 = /^[^'\\\n]/;
  const peg$c392 = peg$classExpectation(["'", "\\", "\n"], true, false);
  const peg$c393 = function(char: any): any { return char; };
  const peg$c394 = "\"";
  const peg$c395 = peg$literalExpectation("\"", false);
  const peg$c396 = /^[^"\\\n]/;
  const peg$c397 = peg$classExpectation(["\"", "\\", "\n"], true, false);
  const peg$c398 = function(chars: any): any { return chars.join(""); };
  const peg$c399 = "true";
  const peg$c400 = peg$literalExpectation("true", false);
  const peg$c401 = function(): any {return true;};
  const peg$c402 = "false";
  const peg$c403 = peg$literalExpectation("false", false);
  const peg$c404 = function(): any {return false;};
  const peg$c405 = "\\\"";
  ...
  const peg$c432 = function(first: any, rest: any): any {return track({construct_type: "unqualified_identifier", identifier: first + rest.join("")}, location(), text());};
  ...
  const peg$c437 = function(id: any, t: any): any { return {identifier: id.identifier + "<" + t.identifier + ">"}; };
  const peg$c438 = "@";
  ...
  const peg$c442 = function(id: any): any { return track({construct_type: "opaque_expression", id: id.join("")}, location(), text()); };
  ...
  const peg$c447 = function(id: any): any {return isUserTypeName(id.identifier);};
  const peg$c448 = function(head: any): any {
        classNameStack.push(head.name.identifier);
        getUserTypeNames()[head.name.identifier]=true;
        return true;
      };
  const peg$c449 = function(head: any, mems: any): any { 
        classNameStack.pop();
        return track({construct_type: "class_definition", head: head, memberSpecs: mems}, location(), text());
      };
  const peg$c450 = function(head: any): any { classNameStack.pop(); return false; };
  const peg$c451 = function(key: any, name: any, b: any): any {return b;};
  const peg$c452 = function(key: any, name: any, bases: any): any { return track({construct_type: "class_head", classKey:key, name:name, bases:bases ?? []}, location(), text()); };
  ...
  const peg$c459 = function(access: any, m: any): any {return m};
  const peg$c460 = function(access: any, members: any): any { return track({construct_type: "member_specification", members: members, access: access}, location(), text()); };
  const peg$c461 = function(m: any): any {return m};
  const peg$c462 = function(members: any): any { return track({construct_type: "member_specification", members: members}, location(), text()); };
  ...
  const peg$c469 = function(specs: any, declarators: any): any {
        return track({construct_type: "simple_member_declaration", specs:specs, declarators:declarators}, location(), text());
      };
  const peg$c470 = function(declarators: any): any {
        return track({construct_type: "simple_member_declaration", specs:emptyDeclSpecs, declarators:declarators}, location(), text());
      };
  const peg$c471 = function(f: any): any { return f; };
  const peg$c472 = "0";
  const peg$c473 = peg$literalExpectation("0", false);
  const peg$c474 = function(d: any): any {d.pureVirtual = true; return d;};
  const peg$c475 = function(d: any): any {d.library_unsupported = true; return d;};
  const peg$c476 = function(d: any, i: any): any {d.initializer = i; return d;};
  const peg$c477 = function(d: any, v: any): any {return v;};
  const peg$c478 = function(d: any, v: any, i: any): any {
        d[v] = true;
        d.initializer = i; return d;
      };
  const peg$c479 = function(d: any, v: any): any {d[v] = true; return d;};
  const peg$c480 = "override";
  const peg$c481 = peg$literalExpectation("override", false);
  const peg$c482 = function(b: any): any {return b};
  const peg$c483 = function(first: any, b: any): any {return b;};
  const peg$c484 = function(a: any): any {return a;};
  const peg$c485 = function(a: any, c: any): any {
  ...
  const peg$c487 = function(c: any): any {
      return track({construct_type: "base_specifier", name: c}, location(), text());};
  const peg$c488 = function(n: any, c: any): any {
      n.push(c);
      return {construct_type: "qualified_identifier", components: n};};
