...
export declare class OutputVerifier extends TestVerifier {
    readonly verifierName = "OutputVerifier";
    readonly expectedOutput: string;
    constructor(expectedOutput: string);
    protected verifyImpl(program: Program): Omit<VerificationStatus, "verifierName">;
}
export declare class EndOfMainStateVerifier extends TestVerifier {
    readonly verifierName = "EndOfMainStateVerifier";
    readonly input: string;
    readonly stepLimit: number;
    private criteria;
    constructor(criteria: (sim: Simulation) => boolean, input?: string, stepLimit?: number);
    protected verifyImpl(program: Program): Omit<VerificationStatus, "verifierName">;
}
/**
