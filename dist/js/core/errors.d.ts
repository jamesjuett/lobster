...
import { CompleteObjectType, ReferenceType, CompleteClassType, Type, AtomicType, PotentiallyCompleteArrayType, PotentiallyCompleteClassType, FunctionType, VoidType, PointerType, ExpressionType, PotentialParameterType, PotentialReturnType, IncompleteObjectType } from "./types";
...
export declare const CPPError: {
    ...
    declaration: {
        ...
        dtor: {
            no_destructor: (construct: TranslationUnitConstruct, entity: ObjectEntity<CompleteClassType>) => CompilerNote;
            no_destructor_local: (construct: TranslationUnitConstruct, entity: LocalObjectEntity) => CompilerNote;
            no_destructor_static: (construct: TranslationUnitConstruct, entity: NamedEntity) => CompilerNote;
            no_destructor_array: (construct: TranslationUnitConstruct, entity: ArraySubobjectEntity) => CompilerNote;
        ...
        func: {
            ...
            noOverrideTarget: (construct: TranslationUnitConstruct) => CompilerNote;
        ...
        array: {
            ...
            too_many_initializers: (construct: TranslationUnitConstruct) => CompilerNote;
        };
        init: {
            scalar_args: (construct: TranslationUnitConstruct, declType: AtomicType) => CompilerNote;
            array_string_literal: (construct: TranslationUnitConstruct, targetType: PotentiallyCompleteArrayType) => CompilerNote;
            ...
            referenceConstness: (construct: TranslationUnitConstruct, from: Type, to: ReferenceType) => CompilerNote;
            ...
            array_value_init: (construct: TranslationUnitConstruct) => CompilerNote;
            array_direct_init: (construct: TranslationUnitConstruct) => CompilerNote;
        };
        storage: {
            extern_prohibited: (construct: TranslationUnitConstruct) => CompilerNote;
        ...
        parameter: {
            storage_prohibited: (construct: StorageSpecifier) => CompilerNote;
            qualified_name_prohibited: (construct: TranslationUnitConstruct) => CompilerNote;
    ...
    expr: {
        assignment: {
            ...
            arrays_not_assignable: (construct: Expression, lhsType: PotentiallyCompleteArrayType) => CompilerNote;
            classes_not_assignable: (construct: Expression, lhsType: PotentiallyCompleteClassType) => CompilerNote;
            type_not_assignable: (construct: Expression, lhsType: FunctionType | VoidType) => CompilerNote;
        ...
        unary: {};
        new: {
            unsupported_type: (construct: TranslationUnitConstruct, type: Type) => CompilerNote;
        };
        new_array: {
            length_required: (construct: TranslationUnitConstruct) => CompilerNote;
            integer_length_required: (construct: TranslationUnitConstruct) => CompilerNote;
            direct_initialization_prohibited: (construct: TranslationUnitConstruct) => CompilerNote;
        };
        delete: {
            ...
            pointerToArrayElemType: (construct: TranslationUnitConstruct, type: Type) => CompilerNote;
        };
        dereference: {
            pointer: (construct: TranslationUnitConstruct, type: Type) => CompilerNote;
            pointerToObjectType: (construct: TranslationUnitConstruct, type: Type) => CompilerNote;
        ...
        thisExpression: {
            nonStaticMemberFunc: (construct: TranslationUnitConstruct) => CompilerNote;
        };
        operatorOverload: {
            no_such_overload: (construct: TranslationUnitConstruct, operator: t_OverloadableOperators) => CompilerNote;
        };
    };
    iden: {
    ...
    link: {
        ...
        func: {
            virtual_def_required: (construct: FunctionDeclaration, func: FunctionEntity) => LinkerNote;
