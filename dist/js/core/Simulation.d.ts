...
declare type SimulationOptions = {
...
export declare class Simulation {
    ...
    readonly hasAnyEventOccurred: boolean;
    ...
    startCleanupUntil(rt: RuntimeConstruct): void;
...
export declare class SimulationInputStream {
    ...
    skipws(): void;
    extractAndParseFromBuffer(type: ArithmeticType): import("./types").ErrorParsingResult | import("./types").SuccessParsingResult<ArithmeticType>;
    extractCharFromBuffer(): string;
    extractIntFromBuffer(): string;
