...
export declare class Memory {
    ...
    allLiveObjects(): CPPObject<CompleteObjectType>[];
     ...
     */
    killObject(obj: CPPObject, killer?: RuntimeConstruct): void;
    /**
...
declare class MemoryHeap {
    ...
    deleteObject(obj: DynamicObject, killer?: RuntimeConstruct): DynamicObject<CompleteObjectType>;
    deleteByAddress(addr: number, killer?: RuntimeConstruct): DynamicObject<CompleteObjectType>;
}
export declare class MemoryFrame {
    ...
    localReferenceLookup<T extends CompleteObjectType>(entity: LocalReferenceEntity<ReferenceType<T>>): CPPObject<T> | undefined;
