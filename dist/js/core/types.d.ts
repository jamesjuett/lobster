...
export declare function sameType(type1: Type | undefined, type2: Type | undefined): boolean;
export declare function similarType(type1: Type | undefined, type2: Type | undefined): boolean;
...
export declare function referenceRelated(from: ExpressionType, to: ReferenceType): boolean;
...
declare abstract class TypeBase {
    ...
    isPointerToCompleteObjectType(): this is PointerToCompleteType;
    ...
    isReferenceToCompleteType(): this is ReferenceToCompleteType;
    ...
    isPotentiallyCompleteArrayType(): this is PotentiallyCompleteArrayType;
...
export declare function isReferenceToCompleteType(type: Type): type is ReferenceToCompleteType;
...
export declare function isBoundedArrayOfType<T extends ArrayElemType>(typePredicate: (type: Type) => type is T): (type: Type) => type is BoundedArrayType<T>;
export declare function isArrayOfUnknownBoundType(type: Type): type is ArrayOfUnknownBoundType;
export declare function isPotentiallyCompleteArrayType(type: Type): type is PotentiallyCompleteArrayType;
...
export declare type PotentiallyCompleteObjectType = AtomicType | PotentiallyCompleteArrayType | PotentiallyCompleteClassType;
 ...
 */
declare abstract class ValueType extends TypeBase implements ObjectTypeInterface {
    abstract size: number;
    abstract isDefaultConstructible(userDefinedOnly?: boolean): boolean;
    abstract isCopyConstructible(requireConstSource: boolean): boolean;
    abstract isCopyAssignable(requireConstSource: boolean): boolean;
    abstract isDestructible(): boolean;
    /**
...
export declare abstract class AtomicType extends ValueType {
    ...
    isDefaultConstructible(userDefinedOnly?: boolean): boolean;
    isCopyConstructible(): boolean;
    isCopyAssignable(): boolean;
    isDestructible(): boolean;
}
...
export declare type AnalyticArithmeticType = IntegralType | AnalyticFloatingPointType;
declare abstract class IntegralTypeBase extends ArithmeticType {
}
export declare type IntegralType = Char | Int | Size_t | Bool;
export declare class Char extends IntegralTypeBase {
...
export declare class Int extends IntegralTypeBase {
...
export declare class Size_t extends IntegralTypeBase {
    readonly simpleType = "size_t";
    readonly size = 8;
    _cvQualifiedImpl(isConst: boolean, isVolatile: boolean): Size_t;
    parse(s: string): ParsingResult<this>;
}
export declare class Bool extends IntegralTypeBase {
...
export declare function toHexadecimalString(addr: number): string;
...
export declare type ReferenceToCompleteType = ReferenceType<CompleteObjectType>;
...
export declare class BoundedArrayType<Elem_type extends ArrayElemType = ArrayElemType> extends TypeBase implements ObjectTypeInterface {
    readonly size: number;
...
export declare type PotentiallyCompleteArrayType<E extends ArrayElemType = ArrayElemType> = BoundedArrayType<E> | ArrayOfUnknownBoundType<E>;
/**
...
declare class ClassTypeBase extends TypeBase implements Omit<ObjectTypeInterface, "size"> {
    ...
    constructor(classId: number, className: string, qualifiedName: QualifiedName, shared: ClassShared, isConst?: boolean, isVolatile?: boolean);
    ...
    isCopyConstructible(this: CompleteClassType, requireConstSource: boolean): boolean;
    isCopyAssignable(this: CompleteClassType, requireConstSource: boolean): boolean;
...
export declare function createClassType(className: string, qualifiedName: QualifiedName): IncompleteClassType;
export declare class FunctionType<ReturnType extends PotentialReturnType = PotentialReturnType> extends TypeBase {
    ...
    readonly paramStrType: string;
    readonly paramStrEnglish: string;
