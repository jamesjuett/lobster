...
export declare class NullptrExpressionOutlet extends ExpressionOutlet<RuntimeNullptrExpression> {
    constructor(element: JQuery, construct: CompiledNullptrExpression, parent?: ConstructOutlet);
}
