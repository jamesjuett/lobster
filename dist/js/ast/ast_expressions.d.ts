...
export declare type t_CompoundAssignmentOperators = "*=" | "/=" | "%=" | "+=" | "-=" | ">>=" | "<<=" | "&=" | "^=" | "|=";
...
export declare type BinaryOperatorExpressionASTNode = ArithmeticBinaryOperatorExpressionASTNode | RelationalBinaryOperatorExpressionASTNode | LogicalBinaryOperatorExpressionASTNode;
export declare type t_BinaryOperators = t_ArithmeticBinaryOperators | t_RelationalBinaryOperators | t_LogicalBinaryOperators;
...
export declare type t_ArithmeticBinaryOperators = "+" | "-" | "*" | "/" | "%" | "&" | "^" | "|" | "<<" | ">>";
...
export declare type t_RelationalBinaryOperators = "<" | ">" | "<=" | ">=" | "==" | "!=";
...
export declare type t_LogicalBinaryOperators = "&&" | "||";
...
export declare type UnaryOperatorExpressionASTNode = PrefixIncrementExpressionASTNode | DereferenceExpressionASTNode | AddressOfExpressionASTNode | UnaryPlusExpressionASTNode | UnaryMinusExpressionASTNode | LogicalNotExpressionASTNode | BitwiseNotExpressionASTNode | SizeofExpressionASTNode | SizeofTypeExpressionASTNode | NewExpressionASTNode | DeleteExpressionASTNode | DeleteArrayExpressionASTNode;
export declare type t_UnaryOperators = "++" | "--" | "*" | "&" | "+" | "-" | "!" | "~" | "sizeof" | "new" | "delete" | "delete[]";
...
export interface NewDeclaratorASTNode extends ASTNode {
    readonly sub?: NewDeclaratorASTNode;
...
export declare type PostfixExpressionASTNode = StaticCastExpressionASTNode | DynamicCastExpressionASTNode | ReinterpretCastExpressionASTNode | ConstCastExpressionASTNode | SubscriptExpressionASTNode | FunctionCallExpressionASTNode | DotExpressionASTNode | ArrowExpressionASTNode | PostfixIncrementExpressionASTNode;
